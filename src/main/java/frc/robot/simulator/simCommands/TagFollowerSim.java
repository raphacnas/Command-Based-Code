package frc.robot.simulator.simCommands;
...
public class TagFollowerSim extends Command {
  ...
  public TagFollowerSim(SimSubsystem SimSubSys, VisionSimSubsystem visionSim) {
    this.SimSubSys = SimSubSys;
    this.visionSim = visionSim;

    addRequirements(SimSubSys);
}
  ...
  public void execute() {
    tagFollower();  
    SmartDashboard();
    SimSubSys.setMotorSpeeds(Lm, Rm);
  }
